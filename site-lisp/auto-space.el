...
;;; Commentary:
;;;
;;; Copied from https://github.com/LuciusChen/.emacs.d/blob/main/site-lisp/auto-space.el
;;;
;;; Code:
...
(defun is-chinese-character (char)
  "Determine if CHAR is a Chinese character."
...
(defun is-halfwidth-character (char)
  "Determine if CHAR is a halfwidth character using `char-width'."
...
ORIG-FUN will be called with ARGS."
  (let ((beg (point))
